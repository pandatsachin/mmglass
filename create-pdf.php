...
//    $pdf->writeHTML('<br><br><br><br><br><hr>', true, false, false, false, '');
 ...
 if (file_exists($pdfpath)) {
    $pdf_url = "JobDetailsPDFs/$pdf_name.pdf"; // Relative URL to access the PDF
    $msg = '<div class="alert alert-success">PDF created successfully! <a href="'.$pdf_url.'" target="_blank">Click here</a> to Download PDF</div>';
} else {
    $msg = '<div class="alert alert-danger">Failed to create PDF.</div>';
}
    }
else{
        $msg = '<div class="alert alert-danger">Job ID not found.</div>';
   ...
   <head>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <h5 class="mb-4" style="margin-top: 60px;" ><?php if (!empty($msg)) echo $msg; ?></h5 >
            <h1 class="mb-4" >Create Job PDF</h1>
