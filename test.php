...
<script>
    async function fetchData() {
        // Using a CORS proxy to bypass CORS restrictions (for development/testing)
        ...
        try {
            ...
            // Parse the JSON data into structured HTML
            const output = document.getElementById("dataOutput");
            output.innerHTML = "";  // Clear loading message
            for (const key in data) {
                const item = document.createElement("div");
                item.innerHTML = `<span class="key">${key}:</span> <span class="value">${data[key]}</span>`;
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-sm-6"><input name="regular_glass[]" class="r_glass form-control addmorevaliR" type="text"
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-sm-6"><input name="large_glass[]" class="l_glass form-control addmorevaliL" type="text"
                                                                     class="form-control width" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
