...
for ($i = 0; $i < $total_box; $i++) {
    ...
    // Handle the double_pane_rg checkbox for each index
    $DoublePaneRegularstrrr = isset($_POST['double_pane_rg'][$i]) ? 1 : 0;

      if ($DoublePaneRegular !== 0) {
...
//    echo '<pre>';
//    print_r($DoublePaneRegularstrrr);
}
exit;
