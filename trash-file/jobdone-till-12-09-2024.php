...
//Save data into DB table
    ...
    for ($i = 0;
            ...
            $i++) {
        $Room = '';
        $Floor = $Top = $Bottom = $RegGlass = $additional_repairs = $LargeGlass = $DoublePaneLarge = $RegRepairs = $UltraLift = 0;
...
//        $DoublePaneLarge_pdf = isset($_POST['double_pane_lg'][$i]) ? '<img src="images/tick.png"> DP' : '';
        if ($DoublePaneRegular !== 0 || $DoublePaneLarge !== 0) {
...
<script type="text/javascript">
    ...
    $(document).on('click', '#addElementField', function () {
        ...
        var new_double_pane_rg = "double_pane_rg[" + cur_val + "]"; // Added for checkbox
        var new_double_pane_lg = "double_pane_lg[" + cur_val + "]"; // Added for checkbox
        var new_top_glass = "top_glass[" + cur_val + "]"; // Added for checkbox
        var new_bottom_glass = "bottom_glass[" + cur_val + "]"; // Added for checkbox
        var new_bottom_glass = "bottom_glass[" + cur_val + "]"; // Added for checkbox
        ...
        form_html = form_html.replace(/double_pane_rg\[\]/g, new_double_pane_rg); // Added for checkbox
        form_html = form_html.replace(/double_pane_lg\[\]/g, new_double_pane_lg); // Added for checkbox
        form_html = form_html.replace(/top_glass\[\]/g, new_top_glass); // Added for checkbox
        form_html = form_html.replace(/bottom_glass\[\]/g, new_bottom_glass); // Added for checkbox
