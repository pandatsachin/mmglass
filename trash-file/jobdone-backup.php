...
if (isset($_POST['save'])) {
    ...
    if (isset($_POST['main_sign']) && trim($_POST['main_sign']) != '') {
        $folderPath = "D:/xampp/htdocs/mmglass/upload/";
...
//        $LargeGlassStr = empty($LargeGlassStr) ? 'Glass:<u style="width:1%;">    </u>' : $LargeGlassStr;
        if (!empty($Room_pdf)) {
            if ($Room == 'Hallway') {
                ...
                $Room_pdf = '&nbsp;<img src="images/tick.png"> <strong>' . $Room_pdf . '</strong><br>';
...
//        if ($Room == 'Kitchen') {
//            $Room_pdf = '&nbsp;<img src="images/tick.png"> <strong>KIT</strong>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/check-box.png"> <strong>BR</strong><br>&nbsp;<img src="images/check-box.png"> <strong>BATH</strong>&nbsp;&nbsp;<img src="images/check-box.png"> <strong>LR</strong>';
//        } elseif ($Room == 'Bedroom') {
//            $Room_pdf = '&nbsp;<img src="images/check-box.png"> <strong>KIT</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/tick.png"> <strong>BR</strong><br>&nbsp;<img src="images/check-box.png"> <strong>BATH</strong>&nbsp;&nbsp;<img src="images/check-box.png"> <strong>LR</strong>';
//        } elseif ($Room == 'Bathroom') {
//            $Room_pdf = '&nbsp;<img src="images/check-box.png"> <strong>KIT</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/check-box.png"> <strong>BR</strong><br>&nbsp;<img src="images/tick.png"> <strong>BATH</strong> &nbsp;<img src="images/check-box.png"> LR';
//        } elseif ($Room == 'Living Room') {
//            $Room_pdf = '&nbsp;<img src="images/check-box.png"> <strong>KIT</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/check-box.png"> <strong>BR</strong><br>&nbsp;<img src="images/check-box.png"> <strong>BATH</strong>&nbsp;&nbsp;<img src="images/tick.png"> <strong>LR</strong>';
//        } else {
//
//            $Room_pdf = '<strong>'.$Room_pdf.'</strong';
//        }
...
//            $glass_type_pdf = '<img src="images/tick.png"> ' . $glass_type_pdf;
        ...
        $RegRepairs = $RedTip_c == 1 ? trim($_POST['sash_value'][$i]) : '<u>    </u>';
        $UltraLift = $UltraLift_c == 1 ? trim($_POST['sash_value'][$i]) : '<u>    </u>';
        $BlackTip = $BlackTip_c == 1 ? trim($_POST['sash_value'][$i]) : '<u>    </u>';
        $BlockTackle = $BlockTackle_c == 1 ? trim($_POST['sash_value'][$i]) : '<u>    </u>';
        ...
        if (!empty($Room_pdf) && $Room !== 'Hallway') {

            $pdftxt .= '<td rowspan="2" style="border-right: 1px solid black; border-bottom: 1px solid black; width:25%;">' . $Room_pdf . '</td>';
        } elseif ($Room == 'Hallway') {
            $pdftxt .= '<td rowspan="2" style="border-right: 1px solid black; border-bottom: 1px solid black; width:25%;">' . $Room_pdf . $Floor . '</td>';
        } else {
            $pdftxt .= '<td colspan="2" style="border-right: 1px solid black; border-bottom: 1px solid black; width:25%;">' . $Room_pdf . '</td>';
        }
        if ($Room == 'Hallway' || $Room == 'Skylight') {
...
//        }
        ...
        if ($Room == 'Kitchen') {
            ...
            if ($Room == 'Hallway') {
                $hfloor = '';
                $Room_pdf = $Room_pdf . '<br><strong>Floor</strong> - <u style="font-size: 12px;">' . $Floor . '</u>';
            } elseif ($Room == 'Skylight') {
                $hfloor = '';
                $Room_pdf = '<strong style="font-size: 12px;"> '.$Room_pdf.'</strong>';
            } else {
...
//        $pdftxt .= '<td colspan="2" style="border-top: 1px solid black; width:75%;">' . $RegGlassStr . $LargeGlassStr . ' ' . $DoublePaneLarge_and_Regular_pdf . ' ' . $size_str3 . $other_str . '</td>';
        ...
        if (!empty($additional_repairsStr)) {
            if (!empty($RegRepairs) || !empty($Locks) || !empty($UltraLift) || !empty($Shoes) || !empty($BlackTip) || !empty($TiltLatch) || !empty($BlockTackle) || !empty($Caps)) {
                ...
                $pdftxt .= '<tr>';
                $pdftxt .= '<td>';
                $pdftxt .= '<strong>Repairs</strong> <u style="font-size: 12px;">' . $additional_repairs . '</u>';
                $pdftxt .= '</td>';
                $pdftxt .= '<td>';
...
//                $pdftxt .= '</tr>';
            ...
            if (!empty($RegRepairs) || !empty($Locks) || !empty($UltraLift) || !empty($Shoes) || !empty($BlackTip) || !empty($TiltLatch) || !empty($BlockTackle) || !empty($Pivot) || !empty($Caps)) {
                ...
                $pdftxt .= '<tr>';
                $pdftxt .= '<td>';
                $pdftxt .= '<strong>Repairs</strong> <u style="font-size: 12px;">' . $RegRepairs . '</u>';
                $pdftxt .= '</td>';
                $pdftxt .= '<td>';
                $pdftxt .= '<strong>UL</strong> <u style="font-size: 12px;">' . $UltraLift . '</u>';
                $pdftxt .= '</td>';
...
//        $pdftxt .= '<tr>';
//        $pdftxt .= '<td>';
//        $pdftxt .= '<strong>Repairs</strong> <u style="font-size: 12px;">    </u>';
//        $pdftxt .= '</td>';
//        $pdftxt .= '<td>';
...
//    }
    ...
    $text .= '<td width="74%" style="border-bottom: 1px solid black; margin: 0; padding: 0;" colspan="1">143433' . $_SESSION['JobID'] . '</td>'; // Underlined text
    $text .= '<td width="5%"><b>Date:</b></td>'; // Label without underline
...
//    $pdf->writeHTMLCell($w = 0, $h = 10, $x = 16, $y = 50, $text, $border = 1, $ln = 1, $fill = 0, $reseth = true, $align = '', $autopadding = true);
    ...
    $pdftxt_header = '<table cellspacing="" cellpadding="" style="border-collapse: collapse;">';
    $pdftxt_header .= '<tr>';
    $pdftxt_header .= '<td width="9%"><b>Address:</b></td>'; // Label without underline
    $pdftxt_header .= '<td width="70%" style="border-bottom: 1px solid black; margin: 0; padding: 0;" colspan="1"> 1 ROMAN BLVD' . $match[0] . '</td>'; // Underlined text
    $pdftxt_header .= '<td width="5%"><b>APT:</b></td>'; // Label without underline
    $pdftxt_header .= '<td width="15%" style="border-bottom: 1px solid black; margin: 0; padding: 0;" colspan="1">156' . $Apt . '</td>'; // Underlined text
...
//    if (!empty($file)) {
//        $html .= '<tr>';
//        $html .= '<td style="width: 40%; height: 100px;">';
//        $html .= '<br><br><div style="border-bottom: 1px solid black;">';
//        $html .= '<img src="' . $file . '" width="200" height="80">';
//        $html .= '</div>';
//
//        $html .= '<strong>Tenant Signature</strong>'; // Add label here
//        $html .= '</td>';
//        $html .= '<td style="width: 10%;"><div></div></td>';
//    } else {
//        $html .= '<tr><td style="width: 40%;"><div></div></td><td style="width: 10%;"><div></div></td>';
//    }
//    if (!empty($techfile)) {
//        $html .= '<td style="width: 40%; height: 100px;">';
//        $html .= '<strong>Technician:</strong> ' . $_SESSION['User']['TechName'] . '<br><div style="border-bottom: 1px solid black;">';
//        $html .= '<img src="' . $techfile . '" width="200" height="80">';
//        $html .= '</div>';
//
//        $html .= '<strong>Tech Signature</strong>'; // Add label here
//        $html .= '</td></tr>';
//    } else {
//        $html .= '<td style="width: 40%;"><div></div></td></tr>';
//    }

//     $html .= '<table cellspacing="5" cellpadding="">';
//    $html .= '<tr><td></td><td><strong>Technician:</strong> ' . $_SESSION['User']['TechName'] . '</td></tr></table>';
//    $html .= '<tr><td><strong>Tenant Signature</strong></td><td> <strong>Tech Signature</strong></td></tr></table>';
//    $html = <<<EOD
//            $html
//            EOD;
//    $pdf->writeHTML($html, true, true, false, false, '');
    ...
    //    start
  $tbl_sign1 = '<table cellspacing="" cellpadding="">';
    $tbl_sign1 .= '<tr><td></td><td><b>Technician:</b> ' . $_SESSION['User']['TechName'] . '</td></tr></table>';
    $tbl_sign1 = <<<EOD
            $tbl_sign1
            EOD;
    $pdf->writeHTML($tbl_sign1, true, true, false, false, '');
    // Calculate the initial Y position to place the images in the same row
$initialY = $pdf->GetY();
...
//    end
    ...
    $html .= '<tr>';
    $html .= '<td style="font-size: 8px;">KIT = KITCHEN, BR = BEDROOM,BATH = BATHROOM,<BR>LR = LIVING ROOM, RW = ROUGH WIRE, PW = POLY WIRE,<BR>CG = CLEAR GLASS, IU = INSULATED UNITS,TL = TILT LATCH,<BR>'
            . 'RB = RED TIP BALANCES, BB = BLACK TIP BALANCES,<BR>DP = DOUBLE PANE, S GLASS = STANDARD GLASS,<BR>L GLASS = LARGE GLASS,UL = ULTRA LIFT BALANCE,<br>'
            . 'WG = Window guards, Cap = Capping, BTB = BlockTackle,<br>ScreenRep =SCREENREPAIR</td>';
...
<body style="align-items: baseline;">
    ...
    <main role="main" class="container jobs_page" style="margin-top: 35px;">
        <div class="row col-sm-12" >
            ...
            <div class="col-sm-9">
                <h1>R.D.S. WINDOWS</h1>
                <H6>info@rdswindowservice.com | romel@rdswindowservice.com</H6>
                <H6>Tel: 516.749.6104 | MER'S ORDER NO. 211 suydam St, Brooklyn, NY 11237, Apt 1L</H6>
            </div>
        </div>
        <!--        <h1 style="text-align: center;">R.D.S. WINDOWS</h1>
                <P style="text-align: center;">info@rdswindowservice.com | romel@rdswindowservice.com</P>
                <P style="text-align: center;">Tel: 516.749.6104 | MER'S ORDER NO. 211 suydam St, Brooklyn, NY 11237, Apt 1L</P>-->
        <?php echo $msg; ?>
        <form name="job_form" method="post" action="" class="job_form" id="job_form" enctype="multipart/form-data">
            <div id="main_div">
                <div id="form_div">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="inner-div">
                                <label for="text-field-1"><strong>Customer's Order No</strong></label>
                                <input type="text" class="form-control" id="text-field-1" placeholder="Customer's Order No">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="inner-div">
                                <label for="text-field-2"><strong>Department</strong></label>
                                <input type="text" class="form-control" id="text-field-2" placeholder="Department">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="inner-div">
                                <label for="date-field"><strong>Date</strong></label>
                    ...
                    <div class="form-group row mt-2">
                        <label for="CityStateZip" class="col-sm-2 col-form-label"><strong>City, State, Zip</strong></label>
                        <div class="col-sm-10">
                            <input name="city_state_zip" type="text" class="form-control" id="CityStateZip" placeholder="City, State, Zip">
                        </div>
                    </div>
                    ...
                    <section>
                        ...
                        <div class="row mt-2 custom-row">
                            <div class="col-sm-6 d-flex"><lable class="mr-2">Size</lable>
                                <input name="size_width[]" type="text" class="mr-2 form-control width glass_size_width" placeholder="Width">
                                <input name="size_height[]" type="text" class="mr-2 form-control width glass_size_height" placeholder="Height">
                                <input name="glass_qty[]" type="text" class="mr-2 form-control width glass_qty" placeholder="Quantity">
                            </div>
                    ...
                    <section>
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-2"><input class="rdosr blocks blocks_a" type="radio" name="repairs[]" value="red">  Red Tip Repairs</div>
                            <!--<div class="col-sm-2"></div>-->

                            <div class="col-sm-2"><input class="rdosr blocks blocks_a" type="radio" name="repairs[]" value="ultra">  UltraLift Repairs</div>
                            <!--<div class="col-sm-2 "></div>-->

                            <div class="col-sm-2"><input class="rdosr blocks blocks_a" type="radio" name="repairs[]" value="black">  Black Tip Repairs</div>
                            <!--<div class="col-sm-2"></div>-->

                            <div class="col-sm-3"><input class="rdosr blocks blocks_a" type="radio" name="repairs[]" value="block"> Block &Tackle Repairs</div>
                            <!--<div class="col-sm-2"></div>-->
                        </div>

                        <div class="row mt-2">
                            <div class="col-sm-8 d-flex"><label class="mr-2" for="sash-Repairs">Sash Repairs</label><div><input name="sash_value[]" type="text" class=" form-control width txtrdosr"
                                                                                                                                placeholder="Quantity"></div></div>
                    ...
                    <section>
                        <div class="row ">
                            <div class="mt-2 col-sm-4 d-flex"><label for="lock-field">Lock:</label><div class="col-sm-12 ml-1"><input name="locks[]" type="text" class="form-control width lstp"></div></div>
                            <div class="mt-2 col-sm-4 d-flex"><label for="lock-field">Shoes:</label><div class="col-sm-12"><input name="shoes[]" type="text" class="form-control width lstp"></div></div>
                            <div class="mt-2 col-sm-4 d-flex"><label for="lock-field">TiltLatch:</label><div class="col-sm-12"><input name="tiltlatch[]" type="text" class="form-control width lstp"></div></div>
                        </div>
                        <div class="row ">
                            <div class="mt-2 col-sm-4 d-flex"><label for="lock-field">Pivot:</label><div class="col-sm-12"><input name="pivot[]" type="text" class="form-control width lstp"></div></div>
                            <div class="mt-2 col-sm-4 d-flex"><label for="lock-field">Caps:</label><div class="col-sm-12 ml-2"><input name="caps[]" type="text" class="form-control width"></div></div>
                    ...
                    <section>
                        <div class="row ">
                            <div class="mt-2 col-sm-4 d-flex"><label class="mr-2" for="lock-field">Insulated Unit:</label><div class=""><input name="insulated_unit[]" type="text" class="form-control width"></div></div>
                            <div class="mt-2 col-sm-4 d-flex"><label class="mr-2" for="lock-field">Window Guards:</label><div class=""><input name="window_guards[]" type="text" class="form-control width"></div></div>
                            <div class="mt-2 col-sm-4 d-flex"><label class="mr-2" for="lock-field">Moldings:</label><div class=""><input name="moldings[]" type="text" class="form-control width"></div></div>
                        </div>
                        <div class="row ">
                            <div class="mt-2 col-sm-4 d-flex"><label class="mr-2" for="lock-field">Screen Repair:</label><div class=""><input name="caps[]" type="text" class="form-control width"></div></div>
                            <div class="mt-2 col-sm-4 d-flex"><label class="" style="margin-right:20px;" for="lock-field">New Screen:</label><div class="ml-3"><input name="new_screen[]" type="text" class="form-control width"></div></div>
                            <div class="mt-2 col-sm-4 d-flex"><div ><label class="mr-2" for="lock-field">Capping:</label></div><div class="ml-2"><input name="capping[]" type="text" class="form-control width"></div></div>
            ...
            <div class="row mt-3">
                <div class="col-sm-3 "><input name="tennant_email" type="text" class="form-control" placeholder="Tenant Email">
                </div>
            </div>
            <div class="row mt-3">
