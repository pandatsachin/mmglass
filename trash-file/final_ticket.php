...
//         Notes
    ...
    $text .= '<td width="72%" style="border-bottom: 1px solid black; margin: 0; padding: 0;" colspan="1">143689' . $_SESSION['JobID'] . '</td>'; // Underlined text
...
//    $pdf->writeHTMLCell($w = 0, $h = 10, $x = 16, $y = 50, $text, $border = 1, $ln = 1, $fill = 0, $reseth = true, $align = '', $autopadding = true);
    ...
    $pdftxt_header .= '<td width="47%" style="border-bottom: 1px solid black; margin: 0; padding-bottom: 10px;" colspan="1"> 1 ROMAN BLVD' . $match[0] . '</td>'; // Underlined text with padding
    $pdftxt_header .= '<td width="6%" style="padding-bottom: 10px;">&nbsp;&nbsp;<b>APT:</b></td>'; // Add padding-bottom for spacing
    $pdftxt_header .= '<td width="10%" style="border-bottom: 1px solid black; margin: 0; padding-bottom: 10px;" colspan="1">156' . $Apt . '</td>'; // Underlined text with padding
