...
////////////////////////////////////second loop////////////////////////////////////////////
    ...
    for ($i = 0;
            ...
            $i++) {
        $Room = '';
        $Floor = $Top = $Bottom = $RegGlass = $additional_repairs = $LargeGlass = $DoublePaneLarge = $DoublePaneRegular = 0;
        $LAMI = $Plexi = $RoughWire = $PolyWire = $RoughWireClear = $PolyWireClear = 0;
        $Height = $Width = 0.0;
        $InsulatedUnit = $NewScreen = $ScreenRepair = $Moldings = $WindowGuards = $Capping = 0;
        $Locks = $Shoes = $TiltLatch = $Pivot = $Caps = 0;
        $Notes = '';
...
//        exit;
//        $pdftxt = '<div style="margin-bottom: -3px; padding-bottom: -3px;">';
        $RegRepairs = empty($RegRepairs) ? '<u>    </u>' : $RegRepairs;
        $UltraLift = empty($UltraLift) ? '<u>    </u>' : $UltraLift;
        $BlackTip = empty($BlackTip) ? '<u>    </u>' : $BlackTip;
        $BlockTackle = empty($BlockTackle) ? '<u>    </u>' : $BlockTackle;
        $RedTip_c = empty($RedTip_c) ? '<u>    </u>' : $RedTip_c;
        $UltraLift_c = empty($UltraLift_c) ? '<u>    </u>' : $UltraLift_c;
        $BlackTip_c = empty($BlackTip_c) ? '<u>    </u>' : $BlackTip_c;
        $BlockTackle_c = empty($BlockTackle_c) ? '<u>    </u>' : $BlockTackle_c;
...
//echo 'sac'.$RegRepairs;
        if (!empty($additional_repairsStr)) {
//            echo $RedTip_c;
            if (!empty($RedTip_c) || !empty($Locks) || !empty($UltraLift_c) || !empty($Shoes) || !empty($BlackTip_c) || !empty($TiltLatch) || !empty($BlockTackle_c) || !empty($Caps)) {
//                if (!empty($RedTip_c)) {
////                    $RegRepairs = trim($_POST['sash_value'][$i]);
...
//                }
                $pdftxt .= '<tr>';
                $pdftxt .= '<td>';
                $pdftxt .= '<strong>RB</strong> <u style="font-size: 12px;">' . $RedTip_c . '</u>';
                $pdftxt .= '</td>';
                $pdftxt .= '<td>';
                $pdftxt .= '<strong>UL</strong> <u style="font-size: 12px;">' . $UltraLift_c . '</u>';
                $pdftxt .= '</td>';
                $pdftxt .= '<td>';
                $pdftxt .= '<strong>BTB</strong> <u style="font-size: 12px;">' . $BlockTackle_c . '</u>';
                $pdftxt .= '</td>';
                $pdftxt .= '<td>';
                $pdftxt .= '<strong>BB</strong> <u style="font-size: 12px;">' . $BlackTip_c . '</u>';
                $pdftxt .= '</td>';
                $pdftxt .= '<td>';
...
<?php echo $msg; ?>
        <form name="job_form" method="post" action="" class="job_form" id="job_form" enctype="multipart/form-data">
                ...
                <div id="form_div">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-sm-6"><input class="form-control add_r" type="text" name="additional_repairs_red[]" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-sm-6">UltraLift Balances</div>
                                        <div class="col-sm-6"><input class="form-control add_u" type="text" name="additional_repairs_ultra[]" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-sm-6">Black Tip Balances</div>
                                        <div class="col-sm-6"><input class="form-control add_bt" type="text" name="additional_repairs_black[]" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-sm-6">Block &Tackle Balances</div>
                                        <div class="col-sm-6"><input class="form-control add_bta" type="text" name="additional_repairs_block[]" placeholder="Quantity"></div>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-sm-6"><input name="additional_locks[]" type="text" class="form-control additional_l" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-sm-6">Shoes</div>
                                        <div class="col-sm-6"><input name="additional_Shoes[]" type="text" class="form-control additional_s" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-sm-6">TiltLatch</div>
                                        <div class="col-sm-6"><input name="additional_TiltLatch[]" type="text" class="form-control additional_t" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-sm-6">Caps</div>
                                        <div class="col-sm-6"><input name="additional_Caps[]" type="text" class="form-control additional_c" placeholder="Quantity"></div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-sm-6">Pivot</div>
                                        <div class="col-sm-6"><input name="additional_Pivot[]" type="text" class="form-control additional_p" placeholder="Quantity"></div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                    ...
                    <div class="saassh_reepp_divvv">
                        <section id="Sash_Repairs" class="Sash_Repairs">
                            <div class="row">
                                <div class="col-sm-2"><input type="checkbox" class="top_glass_c " name="top_glass[]" value="1"> Top</div>
                                <div class="col-sm-2"><input type="checkbox" class="bottom_glass_c " name="bottom_glass[]" value="1"> Bottom</div>
                            </div>
                            <div class="row mt-2">

                                <div class="col-sm-2"><strong>Sash Repairs</strong></div>
                                <div class="col-sm-2"><input name="sash_value[]" type="text" class="form-control txtrdosr" placeholder="Quantity"></div>
                            </div>
                            <div class="row mt-2">
            ...
            <button type="submit" class="btn btn-success mt-3 mb-5 mr-3 " name="save" id="btndone">Done</button>
...
//                        });
                        if (new_reg_glass_val === '') {
                            alert_msg += 'Please enter value in Sash Repairs section\n';
                        }
                    }
                    new_m++;
                });
...
//                        alert_msg += 'Please enter at least one quantity for Sash Repairs\n';
//                    }
//                }
//                blk = 0;
//            }
//        });
        ...
        // Textbox validation
//        const inputFields = $('.additional_Balances, .add_r, .add_u, .add_bt, .add_bta, .additional_l, .additional_s, .additional_t, .additional_c, .additional_p');
//        let filledCount = 0;
//        let emptyCount = 0;
//
...
//            alert_msg += 'Please fill all the input fields of GLASS SECTION.\n';
//        }
        // End textbox validation

        // Select all the elements with the specified classes
//        var emptyFields = false;
//        var classesToCheck = ['.i_u', '.n_s', '.m_d', '.c_p', '.s_r', '.w_g'];
//        // Loop through each class and check if any of them are empty
...
//        });
//        if (emptyFields) {
//            alert_msg += 'Please fill all the input fields of Sash Repairs Section.\n';
//        }
